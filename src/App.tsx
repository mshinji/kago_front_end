...
const Page = () => {
  ...
  const [ryukyokuInfo, setRyukyokuInfo] = useState<RyukyokuInfoType>(defaultRyukyokuInfo)
  const [syukyokuInfo, setSyukyokuInfo] = useState<SyukyokuInfoType>(defaultSyukyokuInfo)
  ...
  const [isAnkanNoticeNested, setIsAnkanNoticeNested] = useState<boolean>(false)
